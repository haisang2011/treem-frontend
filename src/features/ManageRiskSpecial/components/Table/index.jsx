...
export default function CustomPaginationActionsTable({ riskSpecial, listNCHCDB, totalRiskSpecial, onHandlePagination }) {

  const classes = useStyles2();
  const [page, setPage] = React.useState(0);
  const [rowsPerPage, setRowsPerPage] = React.useState(10);

  const emptyRows = rowsPerPage - Math.min(rowsPerPage, riskSpecial.length - page * rowsPerPage);
